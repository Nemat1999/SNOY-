...
import OrderModel from '../../database/models/order.cjs';
...
const models = { User, Session, RateLimit, Category, Product, Order };
...
export default db;
export { sequelize, Sequelize, User, Session, RateLimit, Category, Product, Order };
